...
<!-- endor_agent_kit_managed=true agent_id=oss-upgrade-investigator agent_name=endor-oss-upgrade-investigator-agent host=kiro -->

# OSS Upgrade Investigator

Generated from Endor Agent Kit recipe `oss-upgrade-investigator` v1.0.0 for the Endor Labs Agent Kit Kiro plugin agent.
