...
<!-- endor_agent_kit_managed=true agent_id=configuration-automation agent_name=endor-configuration-automation-agent host=kiro -->

# Configuration Automation

Generated from Endor Agent Kit recipe `configuration-automation` v0.1.0 for the Endor Labs Agent Kit Kiro plugin agent.
