...
<!-- endor_agent_kit_managed=true agent_id=remediation-planning agent_name=endor-remediation-planning-agent host=kiro -->

# Remediation Planning

Generated from Endor Agent Kit recipe `remediation-planning` v0.1.0 for the Endor Labs Agent Kit Kiro plugin agent.
...
URL, Endor project name, finding UUID, or optional project UUID. In Kiro,
