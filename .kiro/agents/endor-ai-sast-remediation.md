...
<!-- endor_agent_kit_managed=true agent_id=ai-sast-remediation agent_name=endor-ai-sast-remediation-agent host=kiro -->

# AI SAST Remediation

Generated from Endor Agent Kit recipe `ai-sast-remediation` v0.1.0 for the Endor Labs Agent Kit Kiro plugin agent.
