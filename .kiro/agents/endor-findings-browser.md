...
<!-- endor_agent_kit_managed=true agent_id=findings-browser agent_name=endor-findings-browser-agent host=kiro -->

# Findings Browser

Generated from Endor Agent Kit recipe `findings-browser` v0.1.0 for the Endor Labs Agent Kit Kiro plugin agent.
